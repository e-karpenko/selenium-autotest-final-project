...
class LoginPage(BasePage):
    ...
    def register_new_user(self, email, password):
        ...
        self.browser.find_element(*LoginPageLocators.INPUT_REGISTER_CONFIRM_PASS).send_keys(password)
    ...
    def should_be_login_url(self):
        assert "login" in self.browser.current_url, "Word 'login' is not founded in current URL"
